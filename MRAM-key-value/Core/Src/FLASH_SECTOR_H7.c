...
// There are 2 BANKS available for H745, BANK 1 (0x0800 0000 - 0x080F FFFF) and BANK 2 (0x0810 0000 - 0x081F FFFF)
...
__RAM_FUNC static uint32_t GetSector(uint32_t Address)
{
  uint32_t sector = 0;
...
__RAM_FUNC uint32_t Flash_Write_Data (uint32_t StartSectorAddress, uint32_t *data, uint16_t numberofwords)
{
...
__RAM_FUNC void Flash_Read_Data (uint32_t StartSectorAddress, uint32_t *data, uint16_t numberofwords)
{
	while (1)
	{
...
float Flash_Read_NUM (uint32_t StartSectorAddress)
{
	...
	value = Bytes2float((uint8_t *) &buffer);
	return value;
}
